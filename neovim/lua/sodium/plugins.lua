...
require("lazy").setup({
    ...
    },
    {
        ...
        keys = {
            { "<leader>sb",       function() Snacks.picker.buffers({ focus = 'list', current = false }) end,             desc = "Buffers" },
            ...
            { "<leader>8",        function() Snacks.picker.grep_word({ hidden = true, focus = 'list' }) end,             desc = "Find Files" },
            -- find
            { "<leader>g",        function() Snacks.picker.git_status({ focus = 'list' }) end,                           desc = "Git Status" },
            -- Grep
            ...
            { "<leader>r",        function() Snacks.picker.resume({ focus = 'list' }) end,                               desc = "Resume" },
