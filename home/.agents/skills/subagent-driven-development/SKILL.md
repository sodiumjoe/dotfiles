...
content_hash: 8dde5589ee083fb4999106d116f01c8fdaf3116a8a9813fdedeb80329de49046
---
...
- Each plan owns a workspace: at skill start, run this skill's
  `bash scripts/sdd-workspace PLAN_FILE` — it prints the plan's directory
  under Git metadata (under `<git-dir>/sdd/`), home to
...
- Check for this plan's ledger at `<workspace>/progress.md`. If its first
  ...
  ledger at the old flat path `<git-dir>/sdd/progress.md` — is another
...
- Removing Git metadata will destroy the workspace; if that happens, recover
  from `git log`.
...
[Read plan file once: ~/stripe/work/projects/<slug>/feature-plan.md]
[Resolve workspace: bash scripts/sdd-workspace ~/stripe/work/projects/<slug>/feature-plan.md — no ledger inside, fresh start]
